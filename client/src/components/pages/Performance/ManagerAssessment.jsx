...
const ManagerAssessment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Self-Assessment Feedback:', selfAssessment);
  };

  return (
    <div className="p-4">
      <h2 className="text-lg font-bold mb-4">Manager Assessment</h2>

      <form onSubmit={handleSubmit} className="mb-4">
        <div className="mb-4">
          <h3 className="text-md font-semibold">Rate Employee Performance</h3>
        ...
        <div className="mb-4">
          <label className="block mb-1">Comments/Suggestions:</label>
          <textarea
            value={comments}
        ...
        <div className="mb-4">
          <label className="block mb-1">Self-Assessment Feedback:</label>
          <textarea
            value={selfAssessment}
            onChange={(e) => setSelfAssessment(e.target.value)}
            placeholder="Add self-assessment feedback here..."
            className="border border-gray-300 rounded p-2 w-full"
            rows="4"
          />
        </div>
