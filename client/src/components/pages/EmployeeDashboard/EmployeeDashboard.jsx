  ...
  return (
    <div className="flex">
      ...
      <div
        ...
        } h-screen bg-gray-100 text-gray-800 flex flex-col transition-all duration-300`}
      >
                ...
                <li key={item.name} className="mb-2">
                  <button
                    ...
                    className={`flex items-center w-full p-3 rounded hover:bg-gray-200 ${
                      activeSubComponent === item.component ? "bg-gray-300" : ""
                    }`}
                  >
      ...
      {/* Main Content */}
      <div className="flex-1 bg-gray-50">{renderSubComponent()}</div>
