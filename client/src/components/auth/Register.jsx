...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
      ...
      >
        <h2 className="text-2xl sm:text-4xl font-bold text-white mb-6 sm:mb-8 text-center">
          Create Account
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 bg-white/5 border ${
                errors.name ? 'border-red-400' : 'border-purple-400'
          ...
          <div className="relative">
            ...
            <input
              ...
              name="email"
              className={`w-full pl-10 pr-4 py-3 bg-white/5 border ${
                errors.email ? 'border-red-400' : 'border-purple-400'
              } rounded-lg text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all`}
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-12 py-3 bg-white/5 border ${
                errors.confirmPassword ? 'border-red-400' : 'border-purple-400'
              } rounded-lg text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all`}
